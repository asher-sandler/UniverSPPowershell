...
$spRequestsListObj.PathXML = "\\ekeksql00\SP_Resources$\HSS\default"
$spRequestsListObj.XMLFileEn = "ASHER-TEST-EN.xml"
$spRequestsListObj.XMLFileHe = "ASHER-TEST-HE.xml"
