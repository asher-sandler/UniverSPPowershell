...
else
{
	if (Test-CurrentSystem $groupName){
		...
		if (Test-Path $jsonFile){
			...
			$siteUrl    = "https://grs2.ekmd.huji.ac.il/home/schoolofsocialwork/SSW45-2022/external_forms"
			$oldSiteURL = "https://grs2.ekmd.huji.ac.il/home/schoolofsocialwork/SSW37-2021/external_forms/"
			...
			#read-host
			$siteDumpFileName = ".\JSON\NoFile-SiteDump.json"
			...
			else
			{
				...
				#Dest
				$PagesName = getListOrDocName $siteUrl "/home/schoolofsocialwork/SSW45-2022/external_forms/Pages" "DocLib"
				$SitePagesName = getListOrDocName $siteUrl "/home/schoolofsocialwork/SSW45-2022/external_forms/SitePages" "DocLib"
				...
				$PagesName = getListOrDocName $oldSiteURL "/home/schoolofsocialwork/SSW37-2021/external_forms/Pages" "DocLib"
				$SitePagesName = getListOrDocName $oldSiteURL "/home/schoolofsocialwork/SSW37-2021/external_forms/SitePages" "DocLib"
