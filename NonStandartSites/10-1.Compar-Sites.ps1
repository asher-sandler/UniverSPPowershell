	...
	if (Test-CurrentSystem $groupName){
		...
		if (Test-Path $jsonFile){
			...
			else
			{
				...
				$PagesName1 = getListOrDocName $siteUrl $($RelURL+"Pages\interviews") "DocLib"
				...
				$pageItems1 = get-allListItemsByID $siteUrl $PagesName1
				#$pageItems
				...
				#https://grs2.ekmd.huji.ac.il/home/socialSciences/SOC46-2022/Pages/interviews/interviewForm306.aspx
				#/home/socialSciences/SOC36-2020/Pages/CancelCandidacy.aspx
				
				$pgObj = "" | Select-Object URL, WebParts
				$pgObj.URL = "/home/socialSciences/SOC46-2022/Pages/interviews/interviewForm306.aspx"
				$pgObj.WebParts = get-PageWebPartAll $siteUrl $pgObj.URL
				$SPages += $pgObj

				$pgObj = "" | Select-Object URL, WebParts
				$pgObj.URL = "/home/socialSciences/SOC46-2022/Pages/interviews/interviewForm367.aspx"
				$pgObj.WebParts = get-PageWebPartAll $siteUrl $pgObj.URL
				$SPages += $pgObj
				...
				$pgObj = "" | Select-Object URL, WebParts
				$pgObj.URL = "/home/socialSciences/SOC46-2022/Pages/interviews/interviewSchedule306.aspx"
				$pgObj.WebParts = get-PageWebPartAll $siteUrl $pgObj.URL
				$SPages += $pgObj
				...
				$pgObj = "" | Select-Object URL, WebParts
				$pgObj.URL = "/home/socialSciences/SOC46-2022/Pages/interviews/interviewSchedule367.aspx"
				$pgObj.WebParts = get-PageWebPartAll $siteUrl $pgObj.URL
				$SPages += $pgObj
				...
				$PagesName1 = getListOrDocName $oldSiteURL $($RelURL+"Pages\interviews") "DocLib"
				$SitePagesName = getListOrDocName $oldSiteURL $($RelURL+"SitePages") "DocLib"
			
			
				#Write-Host $PagesName -f Yellow
				$pageItems = get-allListItemsByID $oldSiteURL $PagesName
				$pageItems1 = get-allListItemsByID $oldSiteURL $PagesName1
				#$pageItems
				...
				$pgObj = "" | Select-Object URL, WebParts
				$pgObj.URL = "/home/socialSciences/SOC36-2020/Pages/interviews/interviewForm306.aspx"
				$pgObj.WebParts = get-PageWebPartAll $oldSiteURL $pgObj.URL
				$SPages += $pgObj

				$pgObj = "" | Select-Object URL, WebParts
				$pgObj.URL = "/home/socialSciences/SOC36-2020/Pages/interviews/interviewForm367.aspx"
				$pgObj.WebParts = get-PageWebPartAll $oldSiteURL $pgObj.URL
				$SPages += $pgObj
				...
				$pgObj = "" | Select-Object URL, WebParts
				$pgObj.URL = "/home/socialSciences/SOC36-2020/Pages/interviews/interviewSchedule306.aspx"
				$pgObj.WebParts = get-PageWebPartAll $oldSiteURL $pgObj.URL
				$SPages += $pgObj
				...
				$pgObj.WebParts = get-PageWebPartAll $oldSiteURL"/home/socialSciences/SOC36-2020/Pages/interviews/interviewSchedule367.aspx"
				$SPages += $pgObj
