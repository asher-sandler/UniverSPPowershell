...
if ($asherTest){
	...
	try
	{
		...
		$cmd.connection = $conn
$cmd.commandtext=@"
INSERT INTO [dbo].[production_users_2] SELECT * FROM [dbo].[temp_users_2]
WHERE f_appended = 1
"@
		$cmd.executenonquery()
		start-sleep 1
...
SELECT [ZEHUT], '1' as ACTION_TYPE_ID,Null as ACTION_RESULT_ID, Null as f_performed, Null as f_performed_date FROM [dbo].[temp_users_2]
WHERE f_appended = 1;
"@
		$cmd.executenonquery()
		start-sleep 1
...
$cmd.commandtext=@"
INSERT INTO [dbo].[production_Pending_Actions_2] 
SELECT [ZEHUT], '3' as ACTION_TYPE_ID,Null as ACTION_RESULT_ID, Null as f_performed, Null as f_performed_date FROM [dbo].[temp_users_2]
WHERE [f_updated] = 1;
"@
		$cmd.executenonquery()
		start-sleep 1
...
$cmd.commandtext=@"
INSERT INTO [dbo].[production_Pending_Actions_2] 
SELECT [ZEHUT], '4' as ACTION_TYPE_ID,Null as ACTION_RESULT_ID, Null as f_performed, Null as f_performed_date FROM [dbo].[temp_users_2]
WHERE [f_regchange] = 1;
"@
		$cmd.executenonquery()
		start-sleep 1
