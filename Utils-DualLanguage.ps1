...
function DefaultDLangContentEn2($relURL){
	...
	$outStr += 	'</li>'
    $outStr += 	'<li>' 
    $outStr += 		'<strong class="ms-rteFontSize-2">B. The following documents should be uploaded via the</strong>' 
    $outStr += 		'<a href="' + $relURL +'Pages/DocumentsUpload.aspx">' 
    $outStr += 		'<span class="ms-rteFontSize-2" dir="ltr" style="text-decoration: underline;"><span>&nbsp;</span>' 
    $outStr += 		'<strong><font color="#0066cc">Documents Upload page</font></strong>'
	$outStr += 		'</span></a>'
	$outStr += 	'</li>'
...
function DefaultDLangContentHe2($relURL){
  ...
  $outStr += '</p>'
  $outStr += '<p dir="rtl" style="text-align:right;">'
  $outStr += '<strong class="ms-rteFontSize-2">ב. להעלות את המסמכים הבאים באמצעות</strong>'
  $outStr += '<a href="' + $relURL +'Pages/DocumentsUpload.aspx">'
  $outStr += '<span class="ms-rteFontSize-2" lang="HE" style="text-decoration:underline;"><span>&nbsp;</span><strong>דף העלאת המסמכים</strong></span>'
  $outStr += '</a>'
  $outStr += '</p>'
